...
@Data
@ApiModel("PDA扫描记录表")
public class GaSacwPdasmjlb implements Serializable {

    private static final long serialVersionUID = -38800212161808549L;
